...
def task(doc_name, from_doctype, to_doctype):
	from cpmerp.accounts.doctype.payment_entry import payment_entry
	from cpmerp.accounts.doctype.purchase_invoice import purchase_invoice
	from cpmerp.accounts.doctype.sales_invoice import sales_invoice
	from cpmerp.buying.doctype.purchase_order import purchase_order
	from cpmerp.buying.doctype.supplier_quotation import supplier_quotation
	from cpmerp.selling.doctype.quotation import quotation
	from cpmerp.selling.doctype.sales_order import sales_order
	from cpmerp.stock.doctype.delivery_note import delivery_note
	from cpmerp.stock.doctype.purchase_receipt import purchase_receipt
