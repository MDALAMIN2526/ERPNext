...
class POSProfile(Document):
	...
	if TYPE_CHECKING:
		...
		from cpmerp.accounts.doctype.pos_customer_group.pos_customer_group import POSCustomerGroup
		from cpmerp.accounts.doctype.pos_item_group.pos_item_group import POSItemGroup
		from cpmerp.accounts.doctype.pos_payment_method.pos_payment_method import POSPaymentMethod
		from cpmerp.accounts.doctype.pos_profile_user.pos_profile_user import POSProfileUser
