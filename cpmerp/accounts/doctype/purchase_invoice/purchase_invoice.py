...
from cpmerp.accounts.doctype.sales_invoice.sales_invoice import (
...
from cpmerp.accounts.party import get_due_date, get_party_account
from cpmerp.accounts.utils import get_account_currency, get_fiscal_year
from cpmerp.assets.doctype.asset.asset import is_cwip_accounting_enabled
...
from cpmerp.controllers.buying_controller import BuyingController
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from cpmerp.accounts.doctype.advance_tax.advance_tax import AdvanceTax
		...
		from cpmerp.accounts.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from cpmerp.accounts.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from cpmerp.accounts.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from cpmerp.accounts.doctype.tax_withheld_vouchers.tax_withheld_vouchers import TaxWithheldVouchers
		from cpmerp.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def get_gl_entries(self, warehouse_account=None):
		self.auto_accounting_for_stock = cpmerp.is_perpetual_inventory_enabled(self.company)
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from cpmerp.stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
...
def make_inter_company_sales_invoice(source_name, target_doc=None):
	from cpmerp.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_transaction
