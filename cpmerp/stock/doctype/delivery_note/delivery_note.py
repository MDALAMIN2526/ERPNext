...
from cpmerp.controllers.accounts_controller import get_taxes_and_charges, merge_taxes
from cpmerp.controllers.selling_controller import SellingController
from cpmerp.stock.doctype.serial_no.serial_no import get_delivery_note_serial_no
...
class DeliveryNote(SellingController):
	...
	if TYPE_CHECKING:
		...
		from cpmerp.stock.doctype.delivery_note_item.delivery_note_item import DeliveryNoteItem
	...
	def update_pick_list_status(self):
		from cpmerp.stock.doctype.pick_list.pick_list import update_pick_list_status
