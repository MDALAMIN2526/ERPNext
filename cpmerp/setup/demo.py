...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "cpmerp")
	try:
		...
		capture("demo_data_creation_failed", "cpmerp", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "cpmerp")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "cpmerp")
	try:
...
def make_transactions(company):
	...
	from cpmerp.accounts.utils import FiscalYearError
