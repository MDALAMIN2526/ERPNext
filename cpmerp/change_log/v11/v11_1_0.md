- Enhancements
	...
	- Other Features
		...
		- A free marketplace where any CPMERP user can list their products and be discovered by thousands of other companies using CPMERP
...
- Changes have been made to ensure CPMERP is compatible with Python 3
