...
from cpmerp.accounts.party import get_due_date_from_template
...
from cpmerp.stock.doctype.material_request.material_request import make_purchase_order
from cpmerp.stock.doctype.material_request.test_material_request import make_material_request
...
class TestPurchaseOrder(FrappeTestCase):
	...
	def test_purchase_order_invoice_receipt_workflow(self):
		from cpmerp.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt
	...
	def test_uom_integer_validation(self):
		from cpmerp.utilities.transaction_base import UOMMustBeIntegerError
	...
	def test_advance_payment_with_separate_party_account_enabled(self):
		...
		from cpmerp.buying.doctype.purchase_order.purchase_order import make_purchase_invoice
