...
from cpmerp.accounts.party import get_dashboard_info, validate_party_accounts
from cpmerp.controllers.website_list_for_contact import add_role_for_portal_user
...
class Customer(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from cpmerp.accounts.doctype.allowed_to_transact_with.allowed_to_transact_with import (
		...
		from cpmerp.utilities.doctype.portal_user.portal_user import PortalUser
	...
	def copy_communication(self):
		...
		from cpmerp.crm.utils import copy_comments, link_communications
	...
	if credit_limit > 0 and flt(customer_outstanding) > credit_limit:
		...
		if not credit_controller_role or credit_controller_role not in frappe.get_roles():
			...
			frappe.msgprint(
				...
				primary_action={
					"label": "Send Email",
					"server_action": "cpmerp.selling.doctype.customer.customer.send_emails",
