...
frappe.pages["sales-funnel"].on_page_load = function (wrapper) {
	...
	wrapper.sales_funnel = new cpmerp.SalesFunnel(wrapper);

	frappe.breadcrumbs.add("Selling");
};

cpmerp.SalesFunnel = class SalesFunnel {
	constructor(wrapper) {
		var me = this;
	...
	get_data(btn) {
		...
		const method_map = {
			sales_funnel: "cpmerp.selling.page.sales_funnel.sales_funnel.get_funnel_data",
			opp_by_lead_source: "cpmerp.selling.page.sales_funnel.sales_funnel.get_opp_by_lead_source",
			sales_pipeline: "cpmerp.selling.page.sales_funnel.sales_funnel.get_pipeline_data",
		};
		frappe.call({
