...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "cpmerp.controllers.queries.item_query";
		dialog.show();
	},
...
cpmerp.bom.BomConfigurator = class BomConfigurator extends cpmerp.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new cpmerp.bom.BomConfigurator({ frm: cur_frm }));
