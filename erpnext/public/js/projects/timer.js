frappe.provide("cpmerp.timesheet");

cpmerp.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	cpmerp.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

cpmerp.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
