...
from cpmerp import get_default_company
from cpmerp.controllers.queries import get_filters_cond
from cpmerp.controllers.website_list_for_contact import get_customers_suppliers
from cpmerp.setup.doctype.holiday_list.holiday_list import is_holiday
...
class Project(Document):
	...
	if TYPE_CHECKING:
		...
		from cpmerp.projects.doctype.project_user.project_user import ProjectUser
