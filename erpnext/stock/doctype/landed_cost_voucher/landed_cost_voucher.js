...
cpmerp.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
cpmerp.stock.LandedCostVoucher = class LandedCostVoucher extends cpmerp.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(cpmerp.stock.LandedCostVoucher);
