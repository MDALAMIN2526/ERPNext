...
from cpmerp.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
...
class TestPurchaseReceipt(FrappeTestCase):
	...
	def test_make_purchase_invoice(self):
		from cpmerp.accounts.doctype.payment_entry.test_payment_entry import create_payment_term
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(cpmerp.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from cpmerp.buying.doctype.purchase_order.purchase_order import (
			make_purchase_invoice as make_purchase_invoice_from_po,
		)
		from cpmerp.buying.doctype.purchase_order.purchase_order import make_purchase_receipt
	...
	def test_purchase_return_with_submitted_asset(self):
		from cpmerp.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_stock_transfer_from_purchase_receipt(self):
		from cpmerp.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from cpmerp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_stock_transfer_from_purchase_receipt_with_valuation(self):
		...
		from cpmerp.stock.get_item_details import get_valuation_rate
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from cpmerp.buying.doctype.purchase_order import purchase_order, test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from cpmerp.accounts.doctype.purchase_invoice.purchase_invoice import (
		...
		from cpmerp.accounts.party import add_party_account
	...
	def test_pr_billed_amount_against_return_entry(self):
		from cpmerp.accounts.doctype.purchase_invoice.purchase_invoice import make_debit_note
		from cpmerp.stock.doctype.purchase_receipt.purchase_receipt import (
...
def prepare_data_for_internal_transfer():
	from cpmerp.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier
