...
from cpmerp.controllers.status_updater import StatusUpdater
...
class POSClosingEntry(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from cpmerp.accounts.doctype.pos_closing_entry_detail.pos_closing_entry_detail import (
			POSClosingEntryDetail,
		)
		from cpmerp.accounts.doctype.pos_closing_entry_taxes.pos_closing_entry_taxes import (
			POSClosingEntryTaxes,
		)
		from cpmerp.accounts.doctype.pos_invoice_reference.pos_invoice_reference import (
			POSInvoiceReference,
		)
	...
	def get_payment_reconciliation_details(self):
		...
		return frappe.render_template(
			"cpmerp/accounts/doctype/pos_closing_entry/closing_voucher_details.html",
