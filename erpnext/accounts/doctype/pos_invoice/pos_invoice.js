...
cpmerp.accounts.pos.setup("POS Invoice");
cpmerp.selling.POSInvoiceController = class POSInvoiceController extends cpmerp.selling.SellingController {
	settings = {};
...
extend_cscript(cur_frm.cscript, new cpmerp.selling.POSInvoiceController({ frm: cur_frm }));
