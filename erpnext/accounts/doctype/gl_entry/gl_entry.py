...
from cpmerp.accounts.party import validate_party_frozen_disabled, validate_party_gle_currency
from cpmerp.accounts.utils import get_account_currency, get_fiscal_year
from cpmerp.exceptions import InvalidAccountCurrency
...
class GLEntry(Document):
	...
	def validate_currency(self):
		company_currency = cpmerp.get_company_currency(self.company)
...
def update_against_account(voucher_type, voucher_no):
	...
	if not entries:
		return
	company_currency = cpmerp.get_company_currency(entries[0].company)
