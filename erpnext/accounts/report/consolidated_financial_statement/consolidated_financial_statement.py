...
import cpmerp
from cpmerp.accounts.report.balance_sheet.balance_sheet import (
	get_chart_data,
...
from cpmerp.accounts.report.cash_flow.cash_flow import (
	add_total_row_account,
	get_account_type_based_gl_data,
	get_cash_flow_accounts,
)
from cpmerp.accounts.report.cash_flow.cash_flow import get_report_summary as get_cash_flow_summary
from cpmerp.accounts.report.financial_statements import (
	filter_out_zero_value_rows,
	get_fiscal_year_data,
	sort_accounts,
)
from cpmerp.accounts.report.profit_and_loss_statement.profit_and_loss_statement import (
...
from cpmerp.accounts.report.utils import convert, convert_to_presentation_currency
...
def get_columns(companies, filters):
	...
	for company in companies:
		...
		if not currency:
			currency = cpmerp.get_company_currency(company)
			...
			if d:
				...
				for company in companies:
					...
					if (
						...
						parent_company_currency = cpmerp.get_company_currency(d.company)
						child_company_currency = cpmerp.get_company_currency(entry.company)
