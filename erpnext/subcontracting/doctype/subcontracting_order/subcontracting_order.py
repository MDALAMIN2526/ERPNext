...
from cpmerp.buying.doctype.purchase_order.purchase_order import is_subcontracting_order_created
...
from cpmerp.stock.stock_balance import update_bin_qty
...
class SubcontractingOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from cpmerp.subcontracting.doctype.subcontracting_order_item.subcontracting_order_item import (
			SubcontractingOrderItem,
		)
		from cpmerp.subcontracting.doctype.subcontracting_order_service_item.subcontracting_order_service_item import (
			SubcontractingOrderServiceItem,
		)
		from cpmerp.subcontracting.doctype.subcontracting_order_supplied_item.subcontracting_order_supplied_item import (
