- Enhancements
	...
	- Other Features
		...
		- A free marketplace where any CMPERP user can list their products and be discovered by thousands of other companies using CMPERP
...
- Changes have been made to ensure CMPERP is compatible with Python 3
